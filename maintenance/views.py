...
def dashboard(request):
    ...
    contractor_count = Contractor.objects.filter(user=request.user).count()

    job_count = MaintenanceJob.objects.filter(user=request.user).count()
...
def property_list(request):
    ...
    return render(request, "maintenance/property_list.html", {"properties": properties})


@login_required
def contractor_list(request):

    contractors = Contractor.objects.filter(user=request.user)

    return render(
        request, "maintenance/contractor_list.html", {"contractors": contractors}
    )
...
def create_property(request):
    ...
    return render(request, "maintenance/create_property.html", context)
...
def edit_property(request, property_id):
    ...
    return render(request, "maintenance/edit_property.html", context)
...
def job_list(request):
    ...
    jobs = MaintenanceJob.objects.filter(user=request.user)
    ...
    context = {"jobs": jobs, "selected_status": status, "search": search, "sort": sort}

    return render(request, "maintenance/job_list.html", context)
...
def create_job(request):
    ...
    if request.method == "POST":
        ...
        form.fields["property"].queryset = Property.objects.filter(user=request.user)
    ...
    return render(request, "maintenance/create_job.html", {"form": form})


@login_required
def delete_job(request, job_id):

    job = MaintenanceJob.objects.get(id=job_id, user=request.user)
...
def edit_job(request, job_id):
    ...
    return render(request, "maintenance/edit_job.html", context)
...
def create_contractor(request):
    ...
    return render(request, "maintenance/create_contractor.html", context)
...
def delete_contractor(request, contractor_id):
    ...
    contractor = Contractor.objects.get(id=contractor_id, user=request.user)
    contractor.delete()
...
def edit_contractor(request, contractor_id):
    ...
    return render(request, "maintenance/edit_contractor.html", context)
